...
class ModelWrapper(object):
    ...
    @cached_property
    @_returns(tuple)
    def fields(self) -> _typing.Sequence['FieldWrapper']:
        for field in self.meta.fields:
            yield FieldWrapper(field, model=self)
    ...
    @cached_property
    def pk(self) -> 'FieldWrapper':
        return FieldWrapper(self.meta.pk)
